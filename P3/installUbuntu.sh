...
VBoxManage createhd --filename "$BASEFOLDER"/$MACHINENAME/$MACHINENAME_DISK.vdi --size 120000 --format VDI
VBoxManage storagectl $MACHINENAME --name "SATA Controller" --add sata --controller IntelAhci
VBoxManage storageattach $MACHINENAME --storagectl "SATA Controller" --port 0 --device 0 --type hdd --medium  "$BASEFOLDER"/$MACHINENAME/$MACHINENAME_DISK.vdi
